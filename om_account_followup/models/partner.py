...
class ResPartner(models.Model):
    ...
    unreconciled_aml_ids = fields.One2many(
        ...
        domain=[('full_reconcile_id', '=', False), ('move_id.payment_state', '!=', 'paid'), ('account_id.account_type', '=', 'asset_receivable'),('parent_state', '=', 'posted'), ('move_type', 'in', ['out_invoice','in_invoice']),]
    )
