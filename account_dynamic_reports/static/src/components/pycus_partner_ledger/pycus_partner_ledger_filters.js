...
export class PycusPartnerLedgerFilters extends PycusFilters {
    setup(){
        super.setup();
        this.getPartnerSubGroupDomain();
        this.state.defaultPartnerTagsValues = this.props.filterValues.defaultPartnerTagsValues;
        this.state.defaultPartnerSubGroupValues = this.props.filterValues.defaultPartnerSubGroupValues;
    ...
    selectedPartnerSubGroup(vals) {
        this.state.partner_sub_group_ids = vals
        this.props.updateValues(this)
    }

    async getPartnerSubGroupDomain() {
        const datas = await rpc('/vendor_sub_groups')
        this.state.partnerSubGroupDomain = datas
    }
}
